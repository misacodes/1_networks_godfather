...
n = 1005
p = mean(degree(email_graph_f)/(n-1))
...
# AVERAGE PATH LENGTH IN ERDOS-RENYI MODEL VS. IN OBSERVED NETWORK 
...
# TRANSITIVITY IN ERDOS-RENYI MODEL VS. IN OBSERVED NETWORK 
...
# AVERAGE PATH LENGTH IN CONFIGURATION MODEL VS. IN OBSERVED NETWORK
...
# TRANSITIVITY IN OBSERVED NETWORK VS. IN CONFIGURATION MODEL
...
# DEGREE DISTRIBUTION IN OBSERVED NETWORK VS. IN ERDOS-RENYI MODEL
...
# DEGREE DISTRIBUTION IN OBSERVED NETWORK VS. IN CONFIGURATION MODEL
